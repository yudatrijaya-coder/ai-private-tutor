...
const SUBJECT_META: Record<string, { emoji: string; color: string }> = {
  ...
  "Matematika Penalaran": { emoji: "🧩", color: "#818cf8" },
  "Matematika Tingkat Lanjut": { emoji: "📐", color: "#818cf8" },
  "Bahasa Indonesia": { emoji: "🇮🇩", color: "#34d399" },
  Bahasa: { emoji: "📖", color: "#34d399" },
  "Bahasa Inggris": { emoji: "🇬🇧", color: "#8b5cf6" },
  "Bahasa Inggris Tingkat Lanjut": { emoji: "🎓", color: "#8b5cf6" },
  "Bahasa Mandarin": { emoji: "🥟", color: "#ef4444" },
  IPA: { emoji: "🔬", color: "#fbbf24" },
  IPAS: { emoji: "🌍", color: "#fbbf24" },
  IPS: { emoji: "🏛️", color: "#f472b6" },
  Ekonomi: { emoji: "💰", color: "#f472b6" },
  Geografi: { emoji: "🗺️", color: "#f472b6" },
  Sosiologi: { emoji: "👥", color: "#f472b6" },
  ...
  Seni: { emoji: "🎨", color: "#ec4899" },
  Sejarah: { emoji: "📜", color: "#a78bfa" },
  Antropologi: { emoji: "🏺", color: "#f472b6" },
};
